                ...
                <div class="grid md:pt-20">
                    <div class="bg-white rounded-lg md:px-10">
                        ...
                        <div class="px-4 pb-6">
                            ...
                            <a href="mailto:pt.pondorakasabamabrur@gmail.com" target="_blank"
                                class="text-md">pt.pondorakasabamabrur@gmail.com</a>
                        </div>
                        ...
                        <div class="px-4 pb-12">
                            ...
                            <a href="mailto:pt.pondorakasabamabrur@gmail.com" target="_blank" class="text-md">Pondok Rajeg Indah Blok A No.4, Cibinong,
                            Bogor, 16914</a>
                        </div>
                    </div>
                </div>
