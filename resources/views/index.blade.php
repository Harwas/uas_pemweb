        ...
        <section class="bg-slate-100 font-poppins">
            <div class="px-10 py-8 text-center space-y-2 lg:pt-14">
                <p class="text-xl font-semibold uppercase">"kualitas menu terbaik <br>dengan harga yang
                    terjangkau."</p>
                <h2 class="text-sm text-yellow-400 font-semibold uppercase">- Owner Kami Bangun Pandito Johan -</h2>
                <h1 class="text-4xl font-euphoria">Bangun Pandito Johan</h1>
            </div>
        ...
        <section class="bg-slate-100 font-poppins">
            ...
            <div class="grid grid-cols-1 py-4 px-4 gap-y-8 pb-10 md:grid-cols-4 md:gap-y-8 md:gap-x-6 md:px-10 md:py-10">
                <div>
                    ...
                    <h1 class="text-xl font-semibold pt-2">Ayam</h1>
                    <p class="text-sm">Goreng / Bakar</p>
                </div>
                ...
                <div>
                    ...
                    <h1 class="text-xl font-semibold pt-2">Ikan</h1>
                    <p class="text-sm">Goreng / Bakar</p>
                </div>
                ...
                <div>
                    ...
                    <h1 class="text-xl font-semibold pt-2">Snack</h1>
                    <p class="text-sm">Kering / Basah</p>
                </div>
                ...
                <div>
                    ...
                    <h1 class="text-xl font-semibold pt-2">Daging</h1>
                    <p class="text-sm">Rendang / Semur</p>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="text-center space-y-3 px-5">
                            ...
                            <ul class="text-lg space-y-2">
                                <li>Pondok Rajeg Indah Blok A No.4, Cibinong, Bogor, 16914</li>
                                <li>0812-9787-9722 (Whatsapp)</li>
                                <li>
