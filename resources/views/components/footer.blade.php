<footer class="bg-zinc-900">
    <div class="mx-auto max-w-screen-xl space-y-8 px-4 pt-16 pb-7 sm:px-6 lg:space-y-16 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
            <div>
                <div class="text-yellow-400 font-poppins flex items-center gap-x-4">
                    ...
                    <h1 class="font-semibold text-3xl">Pondora Catering</h1>
                </div>
                ...
                <ul class="mt-8 flex gap-6">
                    ...
                    <li>
                        <a href="https://instagram.com/pondoracatering" rel="noreferrer" target="_blank"
                ...
                <div>
                    ...
                    <ul class="mt-6 space-y-4 text-md font-poppins">
                        <li class="flex items-center gap-x-4">
                            ...
                            Pondok Rajeg Indah Blok A No.4, Cibinong, Bogor, 16914 </a>
                        </li>
                        ...
                        <li class="flex items-center gap-x-4">
                            ...
                            <a href="https://wa.me/6281297879722" target="_blank"
                                class="text-slate-100 transition hover:opacity-75"> 0812-9787-9722 </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="col-span-3 space-y-6">
                        <div>
                            ...
                            <p class="mt-2 text-gray-500 font-poppins pr-8">Masukkan nomor whatsapp anda di bawah untuk
                                berlangganan informasi dan promosi terbaru seputar Pondora Catering.</p>
                        </div>
                            ...
                            <form class="w-full" name="submit-to-google-sheet">
                                ...
                                <div id="success-message"
                                    ...
                                    <div><span class="font-medium">Berhasil!</span> Nomormu telah masuk dalam
                                        daftar berlangganan informasi seputar Pondora Catering.</div>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <p class="text-sm text-slate-100 font-poppins">&copy; 2024. Pondora Catering. All rights reserved.</p>
        <script>
            const scriptURL =
