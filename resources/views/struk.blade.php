                ...
                <form id="whatsapp-form" action="https://wa.me/6281297879722?text=" method="get" target="_blank"
                    ...
                    <div class="flex flex-col p-8 sm:p-10 bg-white shadow-md rounded-xl">
                        ...
                        <div class="mt-8 sm:mt-12">
                            ...
                            <div class="mt-2">
                                <p class="block text-sm font-medium text-gray-800">pondoracatering.com</p>
                                <p class="block text-sm font-medium text-gray-800">0812-9787-9722</p>
                            </div>
                        </div>

                        <p class="mt-5 text-sm text-gray-500">© 2024 Pondora Catering.</p>
                    </div>
                    <!-- End Card -->
                ...
                <script>
                    ...
                    function prepareWhatsAppMessage() {
                        ...
                        const message =
                            `*Pondora Catering*\n\n` +
                            `*Atas Nama:* ${name}\n` +
                            `*Alamat:* ${address}, Kelurahan ${kelurahan}, Kota Bogor, Indonesia\n\n` +
                            `*Rincian Pembayaran:*\n` +
                            `- Barang: ${menuItemName}\n` +
                            `- Jumlah Barang: ${count}\n` +
