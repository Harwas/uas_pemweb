...
class PemesananController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pemesanan')->with($this->viewData('Pemesanan - Pondora Catering', 'pemesanan', $menuItems));
    }
